...
enum
{
    ...
    OBJ_EVENT_GFX_MAXIE,
    OBJ_EVENT_GFX_PALKIA_FRONT,
    OBJ_EVENT_GFX_DIALGA_FRONT,
    ...
    OBJ_EVENT_GFX_PALKIA_SIDE,
    OBJ_EVENT_GFX_DIALGA_SIDE,
    ...
    OBJ_EVENT_GFX_FATHER,
    OBJ_EVENT_GFX_SPY,
    OBJ_EVENT_GFX_ACE_F,
    OBJ_EVENT_GFX_ACE_M,
    OBJ_EVENT_GFX_ACTOR_F,
    OBJ_EVENT_GFX_ACTOR_M,
    OBJ_EVENT_GFX_AROMA,
    OBJ_EVENT_GFX_AGENT,
    OBJ_EVENT_GFX_BABY,
    OBJ_EVENT_GFX_BALLER,
    OBJ_EVENT_GFX_BREEDER,
    OBJ_EVENT_GFX_BIKER,
    OBJ_EVENT_GFX_BACK,
    OBJ_EVENT_GFX_BURGLAR,
    OBJ_EVENT_GFX_CELEBRITY,
    OBJ_EVENT_GFX_CLERK,
    OBJ_EVENT_GFX_CLOWN,
    OBJ_EVENT_GFX_DOCTOR,
    OBJ_EVENT_GFX_DRAGON,
    OBJ_EVENT_GFX_ENGINEER,
    OBJ_EVENT_GFX_FARMER,
    OBJ_EVENT_GFX_FIRE_B,
    OBJ_EVENT_GFX_FIRE_F,
    OBJ_EVENT_GFX_GUITARIST,
    OBJ_EVENT_GFX_GYMGUY,
    OBJ_EVENT_GFX_LINE,
    OBJ_EVENT_GFX_NINJA,
    OBJ_EVENT_GFX_OFFICER,
    OBJ_EVENT_GFX_PAINTER,
    OBJ_EVENT_GFX_PARASOL,
    OBJ_EVENT_GFX_RANGER,
    OBJ_EVENT_GFX_RAPPER,
    OBJ_EVENT_GFX_SERGEANT,
    OBJ_EVENT_GFX_SHADES,
    OBJ_EVENT_GFX_SINGER,
    OBJ_EVENT_GFX_THUG,
    OBJ_EVENT_GFX_BOARDER,
    OBJ_EVENT_GFX_STRIKER,
    OBJ_EVENT_GFX_TEEN_F,
    OBJ_EVENT_GFX_TEEN_M,
    OBJ_EVENT_GFX_TENNIS,
    OBJ_EVENT_GFX_VIOLINIST,
    OBJ_EVENT_GFX_NERD,
    OBJ_EVENT_GFX_S_EQUINO_M,
    OBJ_EVENT_GFX_S_EQUINO_F,
    OBJ_EVENT_GFX_SPARK_ADMIN,
    OBJ_EVENT_GFX_SPARK_LEADER,
    OBJ_EVENT_GFX_BLOOD,
    OBJ_EVENT_GFX_ASHES,
    OBJ_EVENT_GFX_PORTAL,
    OBJ_EVENT_GFX_FIRE,
    OBJ_EVENT_GFX_ALISTAIR,
    OBJ_EVENT_GFX_XYLAR,
    OBJ_EVENT_GFX_FIONA,
    OBJ_EVENT_GFX_VOSS,
    OBJ_EVENT_GFX_KAEL,
    OBJ_EVENT_GFX_COLRESS,
    OBJ_EVENT_GFX_EVELYN,
    OBJ_EVENT_GFX_DISTORTION_PORTAL,
    OBJ_EVENT_GFX_NIHIL,
    OBJ_EVENT_GFX_FIONA_1,
    NUM_OBJ_EVENT_GFX,
};
